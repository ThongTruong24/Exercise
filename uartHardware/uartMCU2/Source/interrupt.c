...
* Date: 02/01/2003
* Description: config TIM2 and check data to be received from USART1
*/
...
void TIM2_IRQHandler () {
	...
	if (TIM_GetITStatus(TIM2, TIM_IT_Update)) {
		...
		/* Check data to be received from USART1 */
    if (USART1->SR & USART_SR_RXNE) USART1_Receive_Transmit();
