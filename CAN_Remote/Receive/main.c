...
*/
void Feedback_Pressure (uint8_t *data, uint8_t len, uint16_t id) {
	
  CanRxMsg RxMessage;
  CAN_Receive(CAN1, CAN_FIFO0, &RxMessage);	
	/* Wait until the request to send back pressure data is received */
...
int main(){
  ...
  uint8_t data[3] = {53, 63, 72};
	
  Feedback_Pressure(data, 3, 0x0000);
